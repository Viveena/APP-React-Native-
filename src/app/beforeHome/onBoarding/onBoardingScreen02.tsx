      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.textLine}>
            <Text style={styles.regular}>Let’s{'\n'}</Text>
            <Text style={styles.regular}>Create Your{'\n'}</Text>
            <Text style={styles.bold}>Better Life,{'\n'}</Text>
            <Text style={styles.regular}>Together</Text>
          </Text>
        </View>

        {/* Image */}
        <Image
          source={require('@/src/assets/images/onBoardingScreen02_image.png')}
          style={styles.image}
          resizeMode="contain"
        />
        ...
        <View style={styles.bottomRow}>
          ...
          <ArrowButton onPress={() => router.push('/beforeHome/onBoarding/onBoardingScreen03')} 
            style={{marginLeft:20}}/>
        </View>
      </View>
    </ImageBackground>
