      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.textLine}>
            <Text style={styles.regular}>Wellness{'\n'}made </Text>
            <Text style={styles.bold}>simple,{'\n'}</Text>
            <Text style={styles.bold}>habits{'\n'}</Text>
            <Text style={styles.regular}>made stronger</Text>
          </Text>
        </View>

        {/* Image */}
        <Image
          source={require('@/src/assets/images/01_onBoarding_image.png')}
          style={styles.image}
          resizeMode="contain"
        />
        ...
        <View style={styles.bottomRow}>
          ...
          <ArrowButton onPress={() => router.push('/beforeHome/onBoarding/onBoardingScreen02')} 
            style={{marginLeft:20}}/>
        </View>
      </View>
    </ImageBackground>
